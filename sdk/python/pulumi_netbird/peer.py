...
class _PeerState:
    def __init__(__self__, *,
                 ...
                 geoname_id: Optional[pulumi.Input[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.int] geoname_id: Peer Location ID
    ...
    def geoname_id(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        Peer Location ID
        """
    ...
    @geoname_id.setter
    def geoname_id(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class Peer(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="geonameId")
    def geoname_id(self) -> pulumi.Output[_builtins.int]:
        """
        Peer Location ID
        """
        return pulumi.get(self, "geoname_id")
