...
class NetworkResourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] address: Network resource address (either a direct host like 1.1.1.1 or 1.1.1.1/32, or a subnet like 192.168.178.0/24, or domains
               like example.com and *.example.com)
        :param pulumi.Input[Sequence[pulumi.Input[str]]] groups: Group IDs containing the resource
        :param pulumi.Input[str] name: NetworkResource Name
        :param pulumi.Input[str] network_id: The unique identifier of a network
        :param pulumi.Input[str] description: NetworkResource Description
        :param pulumi.Input[bool] enabled: NetworkResource status
        """
...
class NetworkResource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            groups: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            name: Optional[pulumi.Input[str]] = None,
            network_id: Optional[pulumi.Input[str]] = None) -> 'NetworkResource':
        """
