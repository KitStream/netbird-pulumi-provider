...
def get_identity_provider(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbird:index/getIdentityProvider:getIdentityProvider', __args__, opts=opts, typ=GetIdentityProviderResult).value
...
def get_identity_provider_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbird:index/getIdentityProvider:getIdentityProvider', __args__, opts=opts, typ=GetIdentityProviderResult)
