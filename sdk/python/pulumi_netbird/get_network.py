...
def get_network(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbird:index/getNetwork:getNetwork', __args__, opts=opts, typ=GetNetworkResult).value
...
def get_network_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbird:index/getNetwork:getNetwork', __args__, opts=opts, typ=GetNetworkResult)
