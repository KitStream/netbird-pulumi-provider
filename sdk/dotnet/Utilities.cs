...
namespace Pulumi.KitStream.Netbird
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/KitStream/netbird-pulumi-provider";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.KitStream.Netbird.version.txt");
    ...
    internal sealed class NetbirdResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NetbirdResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
