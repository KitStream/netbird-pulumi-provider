...
namespace Pulumi.Netbird.Inputs
{
    ...
    public sealed class PolicyRuleGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.PolicyRuleDestinationResourceGetArgs>? DestinationResource { get; set; }
        ...
        [Input("portRanges")]
        private InputList<Inputs.PolicyRulePortRangeGetArgs>? _portRanges;

        /// <summary>
        /// Policy Rule Port Ranges (mutually exclusive with ports)
        /// </summary>
        public InputList<Inputs.PolicyRulePortRangeGetArgs> PortRanges
        {
            get => _portRanges ?? (_portRanges = new InputList<Inputs.PolicyRulePortRangeGetArgs>());
        ...
        public Input<Inputs.PolicyRuleSourceResourceGetArgs>? SourceResource { get; set; }
