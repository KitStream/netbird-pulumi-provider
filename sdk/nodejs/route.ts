...
export class Route extends pulumi.CustomResource {
     ...
     */
    public readonly accessControlGroups!: pulumi.Output<string[] | undefined>;
    /**
     * Route description
     */
     ...
     */
    public readonly keepRoute!: pulumi.Output<boolean>;
    /**
    ...
    constructor(name: string, argsOrState?: RouteArgs | RouteState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["keepRoute"] = state ? state.keepRoute : undefined;
            ...
            resourceInputs["keepRoute"] = args ? args.keepRoute : undefined;
...
export interface RouteState {
     ...
     * Indicate if the route should be kept after a domain doesn't resolve that IP anymore
     */
    keepRoute?: pulumi.Input<boolean>;
    /**
     * Indicate if peer should masquerade traffic to this route's prefix
     */
