...
func NewToken(ctx *pulumi.Context,
	...
	var resource Token
	err := ctx.RegisterResource("netbird:index/token:Token", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetToken(ctx *pulumi.Context,
	...
	var resource Token
	err := ctx.ReadResource("netbird:index/token:Token", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Token Expiration Date
func (o TokenOutput) ExpirationDate() pulumi.StringOutput {
	return o.ApplyT(func(v *Token) pulumi.StringOutput { return v.ExpirationDate }).(pulumi.StringOutput)
}

func (o TokenOutput) ExpirationDays() pulumi.IntOutput {
	return o.ApplyT(func(v *Token) pulumi.IntOutput { return v.ExpirationDays }).(pulumi.IntOutput)
}
