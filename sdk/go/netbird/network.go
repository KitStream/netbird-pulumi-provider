...
func NewNetwork(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("netbird:index/network:Network", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetwork(ctx *pulumi.Context,
	...
	var resource Network
	err := ctx.ReadResource("netbird:index/network:Network", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Policy IDs associated with resources inside this Network
func (o NetworkOutput) Policies() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Network) pulumi.StringArrayOutput { return v.Policies }).(pulumi.StringArrayOutput)
}

// Network Resource IDs
func (o NetworkOutput) Resources() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Network) pulumi.StringArrayOutput { return v.Resources }).(pulumi.StringArrayOutput)
}

// Network Router IDs
func (o NetworkOutput) Routers() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Network) pulumi.StringArrayOutput { return v.Routers }).(pulumi.StringArrayOutput)
}
