...
func NewIdentityProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("netbird:index/identityProvider:IdentityProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIdentityProvider(ctx *pulumi.Context,
	...
	var resource IdentityProvider
	err := ctx.ReadResource("netbird:index/identityProvider:IdentityProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
